...
public class ConvertFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        convertInflater = inflater.inflate(R.layout.fragment_convert, container, false);

        Config.setHeader("Currency Converter");

        return convertInflater;
    }
}